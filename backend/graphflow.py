...
from route import RouteQuery, question_router
...
def web_search(state):
    ...
    if isinstance(docs, list) and all(isinstance(d, str) for d in docs):
        web_results = "\n".join(docs)
    # 假设 docs 是字典列表且有 "content" 键
    elif isinstance(docs, list) and all(isinstance(d, dict) and "content" in d for d in docs):
